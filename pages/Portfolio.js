    ...
    >
      <div className="selection:bg-cyan-500 selection:text-white">
        <p className="mb-2">
          ...
          teknisenä/desing-näyttönä. Halusin tehdä erikseen klikattavat
          työnäyte-kortit, joiden sisällä löytyy tietoa projekteista, koska
          halusin avata enemmän sellaisia asioita, jotka GitHubiin kirjoitettuna
        ...
        <p className="mb-2">
          ...
          herättää hahmotelma henkiin (muokaten ideaa niin, ettei se liikaa
