  ...
  return (
    ...
    >
      <p className="mb-2">
        ...
        koulutustaustaa tai vankkaa harrastuneisuutta liittyen ohjelmointiin tai
        devaamiseen. Ennen varsinaista työsuhdetta olin muutaman kuukauden
        työharjoittelussa, jossa sain osoitettua motivaationi ja oppimiskykyni.
      </p>

      <p className="mb-2">
        Ensimmäiseksi tehtäväkseni sain päivittää DT:n omia kotisivuja. Tehtävä
        ei ollutkaan aivan helppo, koska alkuperäinen sivusto oli kirjoitettu
        minulle alottaessani täysin tuntemattomalla Alpine.js:llä ja
        Tailwindillä, ja lisäksi sivu käytti Lector-nimistä CMS:ää, joka oli
        mielestäni ehkä hieman hankala käyttää Windowsilla. Käänsin sivun ensin
        kokonaan uudelleen html:ksi ja puhtaaksi CSS:ksi. Tämän jälkeen
      ...
      <p className="mb-2">
        Lisäksi tein asiakasprojektia (vielä julkaisematon), sekä pikkuruisia
        Front end-twiikkauksia Satakolkyt-nimisen hankkeen sivuille. Opin
        työsuhteeni aikana Reactia, Next.js:ää, Azuren perusteita,
        Githubin/gitin tehokkaampaa käyttöä, Tailwind CSS:ää ja tietenkin
        JavaScriptiä.
      </p>
      <p>
        Digitalentsilla totuin myös itselleni erittäin sopivaan agileen
        työtapoihin -ja ympäristöön. Työhön kuului päivittäiset dailyt, jossa
        käytiin läpi tiimin jokaisen henkilön päivän tehtävät. Työt tehtiin
        sprinteissä, ja jokaisen sprintin päätteessä tehtiin esimiehen ja tiimin
        kanssa sprint review,jossa yhdessä mietittiin projektien tilaa ja
        tulevia haasteita. Olen aina pitänyt projektinhallinnassa
        kanban-menetelmästä. Innostuin huomattuani että Trello/Jiramaisen
        projektinhallintatyökalu oli implementoitu myös GitHubiin.
      </p>
    </CaseWrapper>
  )
}
