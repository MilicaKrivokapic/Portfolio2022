...
export const TailwindBadge = () => {
  return (
    <span className="bg-cyan-100 text-cyan-500 font-Work text-sm font-semibold mr-2 px-2.5 py-0.5 rounded ">
      Tailwind
    </span>
  )
}
...
export const NextBadge = () => {
  return (
    <span className="bg-pink-100 text-pink-500 font-Work text-sm font-semibold mr-2 px-2.5 py-0.5 rounded ">
      Next.js
    </span>
  )
}
export const CSharpBadge = () => {
  return (
    <span className="bg-violet-100 text-violet-500 font-Work text-sm font-semibold mr-2 px-2.5 py-0.5 rounded ">
      C#
    </span>
  )
}
export const UIBadge = () => {
  return (
    <span className="bg-amber-100 text-amber-600 font-Work text-sm font-semibold mr-2 px-2.5 py-0.5 rounded ">
      Design
    </span>
  )
}
