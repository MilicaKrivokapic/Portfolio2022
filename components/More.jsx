  ...
  return (
    <section>
      ...
      <div className="w-full flex justify-center">
        <div className="flex lg:flex-row-reverse flex-col justify-around mb-64 bg-gradient-to-b md:bg-gradient-to-l from-[#010307] to-[#00003A] text-white py-20 w-full px-7 xl:px-20 lg:w-5/6 md:rounded-2xl mt-40">
          ...
          <div className="font-Work flex flex-col justify-center items-center text-left float-left">
            ...
            >
              ...
              <div className="">
                ...
                <p className=" font-Quick font-semibold text-center mt-10 mb-20">
